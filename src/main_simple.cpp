 ...
 PropertyOfObject neihbourProperty)
{
 ...
 switch (neighbour)
 {
	case UP:
	{
	  ...
	  {
		if (i != 0 && i != 1 && i != 2) {
		  tree &= !(p[currentProperty.propertyNumber_][i][currentProperty.propertyValue_] ^ p[neihbourProperty.propertyNumber_][i - ROW_LENGTH][neihbourProperty.propertyValue_]); // ��������� xor - ���������������
		}
		else {
